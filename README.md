...
**6. Manager**
  ...
  - 5-2. 개인 정보 변경 기능
    - 5-2-1. Change Info (/mana/changeInfo.jsp): 매니저가 자신의 개인 정보를 수정할 수 있는 페이지입니다. 이 페이지를 통해 매니저는 직업, 생년월일, 계좌번호 등의 정보를 최신 상태로 유지할 수 있습니다.
  ...
  - 5-3. 경기 관련 기능
    ...
    - 5-3-3. Match Cacel Process (/mana/proc/matchDeleteManaProc.jsp):자신이 매치 매니저로 속한 목록에서 Match_ID를 확인하여 Match tuple의 manager attribute에 
Manager ID_Number를 null로 update합니다
  - 5-4. 평가 관련 기능
